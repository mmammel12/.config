# Generated by Powerlevel10k configuration wizard on 2025-03-12 at 13:33 CDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Check if branch name matches ticket pattern (e.g., REPORTING-10151-do-the-thing)
      if [[ $branch =~ ^[A-Z]+-[0-9]+ ]]; then
        # Extract just the ticket number (e.g., REPORTING-10151)
        local ticket_number=${branch[(ws:-:)1]}-${branch[(ws:-:)2]}
        res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${ticket_number//\%/%%}"
      else
